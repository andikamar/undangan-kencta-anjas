...
<small class="mt-0 mb-1 mx-0 p-0"
    style="font-family: 'Cormorant Garamond', serif; color: #4E7C59;">
    ${util.escapeHtml(guestName?.getAttribute('data-message'))}
</small>
...
const pauseAutoScroll = () => {
    ...
    // tunggu 3 detik tanpa interaksi → lanjut lagi
    ...
    const buildGoogleCalendar = () => {
        ...
        const data = new URLSearchParams({
            action: 'TEMPLATE',
            text: 'The Wedding of Kencta & Anjas',
            dates: `${formatDate('2026-03-28 09:00')}/${formatDate('2026-03-28 17:00')}`,
            details: 'With all due respect, we kindly invite you to attend our wedding ceremony. Thank you for your attention and for your prayers and blessings, which would be a great happiness and honor for us.',
            location: 'Jl. Cimone Alam Permai Blok A3 No.6, RT.001/RW.010, Kel. Cibodas, Kec. Cibodas, Kota Tangerang, Banten 15114',
            ctz: config.get('tz'),
        });
